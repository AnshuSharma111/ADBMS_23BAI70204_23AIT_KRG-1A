...
/*
Types of joins:
1. Ineer Join						: Common Data		: L intersection R
2. Left Outer Join/ Left Join		: L + Common Data	: L union (L intersection R)
3. Right Outer Join/ Right Join		: Common Data + R	: R union (L intesection R)
4. Full Outer Join					: L + Common + R	: L union R
5. Self Join
6. Left Exclusive Join				: L - Common		: L - (L intersection R)
7. Right Exclusive Join				: R - Common		: R - (R intersection L)
*/
